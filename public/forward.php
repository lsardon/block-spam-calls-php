...
// Simple decision
if ($spamCount >= 2) {
    $response->say('This call has been blocked due to spam detection.');
    $response->hangup();
} else {
    // Forward to your number or Growably
    $response->dial('+12145500953'); // Your number
}
